...
OaksLab_MapEvents:
	...
	object_event  7,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, PikachuPokeBallScript, EVENT_PIKACHU_POKEBALL_IN_OAKS_LAB
