...
Route2_MapEvents:
	...
	warp_event  3, 29, VIRIDIAN_FOREST_SOUTH_GATE, 2
	warp_event  3, 17, VIRIDIAN_FOREST_NORTH_GATE, 1
	...
	bg_event 15, 24, BGEVENT_ITEM, Route2HiddenMaxEther
	bg_event 18, 24, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event 16, 24, BGEVENT_ITEM, Route2HiddenFullRestore
	bg_event 17, 24, BGEVENT_ITEM, Route2HiddenRevive
	...
	object_event 15, 11, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2DireHit, EVENT_ROUTE_2_DIRE_HIT
	object_event 17, 11, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2MaxPotion, EVENT_ROUTE_2_MAX_POTION
	...
	object_event 16, 12, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
