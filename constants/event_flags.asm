...
; Crystal-exclusive events in Johto
	...
	const EVENT_0C7
; Kanto story events
	const EVENT_REDS_HOUSE_2F_POCKET_PC
	const EVENT_GOT_A_POKEMON_FROM_OAK
	const EVENT_GOT_PIKACHU_FROM_OAK
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_DENNIS
; Officer
...
; Bug CatcherF
	const EVENT_BEAT_BUG_CATCHERF_NADINE
...
; Kanto itemballs
	const EVENT_PIKACHU_POKEBALL_IN_OAKS_LAB
