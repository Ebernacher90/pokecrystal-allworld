...
MonMenuIcons:
	...
	db ICON_CATERPILLAR ; SURSKIT
	db ICON_MOTH		; MASQUERAIN
	db ICON_ODDISH		; SHROOMISH
	db ICON_ODDISH		; BRELOOM
	db ICON_MONSTER		; SLAKOTH
	db ICON_MONSTER		; VIGOROTH
	db ICON_MONSTER		; SLAKING
	db ICON_CATERPILLAR ; NINCADA
	db ICON_MOTH		; NINJASK
	db ICON_MOTH		; SHEDINJA
	db ICON_JIGGLYPUFF	; WHISMUR
	db ICON_JIGGLYPUFF	; LOUDRED
	db ICON_JIGGLYPUFF	; EXPLOUD
	...
	db ICON_GEODUDE		; ARON
	db ICON_GEODUDE		; LAIRON
	db ICON_GEODUDE		; AGGRON
	db ICON_FIGHTER		; MEDITITE
	db ICON_FIGHTER		; MEDICHAM
