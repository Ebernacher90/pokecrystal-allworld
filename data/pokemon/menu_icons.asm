...
MonMenuIcons:
	...
	db ICON_ODDISH		; TREECKO
	db ICON_ODDISH		; GROVYLE
	db ICON_ODDISH		; SCEPTILE
	db ICON_CHARMANDER	; TORCHIC
	db ICON_CHARMANDER	; COMBUSKEN
	db ICON_CHARMANDER	; BLAZIKEN
	db ICON_FISH		; MUDKIP
	db ICON_FISH		; MARSHTOMP
	db ICON_FISH		; SWAMPERT
