...
MonMenuIcons:
	...
	db ICON_GROVYLE		; GROVYLE
	db ICON_SCEPTILE	; SCEPTILE
	db ICON_TORCHIC		; TORCHIC
	db ICON_COMBUSKEN	; COMBUSKEN
	db ICON_BLAZIKEN	; BLAZIKEN
	db ICON_MUDKIP		; MUDKIP
	db ICON_MARSHTOMP	; MARSHTOMP
	db ICON_SWAMPERT	; SWAMPERT
	db ICON_POOCHYENA	; POOCHYENA
	db ICON_MIGHTYENA	; MIGHTYENA
	db ICON_ZIGZAGOON	; ZIGZAGOON
	db ICON_LINOONE		; LINOONE
	db ICON_WURMPLE		; WURMPLE
	db ICON_SILCOON		; SILCOON
	db ICON_BEAUTIFLY   ; BEAUTIFLY
	db ICON_CASCOON		; CASCOON
	db ICON_DUSTOX      ; DUSTOX
	db ICON_LOTAD		; LOTAD
	db ICON_LOMBRE		; LOMBRE
	db ICON_LUDICOLO	; LUDICOLO
	db ICON_SEEDOT		; SEEDOT
	db ICON_NUTZLEAF	; NUZLEAF
	db ICON_SHIFTRY		; SHIFTRY
	db ICON_TAILLOW		; TAILLOW
	db ICON_SWELLOW		; SWELLOW
	...
	db ICON_BRELOOM		; BRELOOM
	db ICON_SLAKOTH		; SLAKOTH
	db ICON_VIGOROTH	; VIGOROTH
	db ICON_SLAKING		; SLAKING
	db ICON_NINCADA		; NINCADA
	db ICON_NINJASK		; NINJASK
	db ICON_SHEDINJA	; SHEDINJA
	db ICON_WHISMUR		; WHISMUR
	db ICON_LOUDRED		; LOUDRED
	db ICON_EXPLOUD		; EXPLOUD
	db ICON_MAKUHITA	; MAKUHITA
	db ICON_HARIYAMA	; HARIYAMA
	db ICON_AZURILL		; AZURILL
	db ICON_NOSEPASS	; NOSEPASS
	db ICON_SKITTY		; SKITTY
	db ICON_DELCATTY	; DELCATTY
	db ICON_SABLEYE		; SABLEYE
	db ICON_MAWILE		; MAWILE
	db ICON_ARON		; ARON
	db ICON_LAIRON		; LAIRON
	db ICON_AGGRON		; AGGRON
	db ICON_MEDITITE	; MEDITITE
	db ICON_MEDICHAM	; MEDICHAM
	db ICON_ELECTRIKE	; ELECTRIKE
	db ICON_MANECTRIC	; MANECTRIC
