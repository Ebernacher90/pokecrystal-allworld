...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_VIRIDIAN_FOREST, INDOOR, VIRIDIAN_CITY, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestSouthGate, TILESET_VIRIDIAN_FOREST_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestNorthGate, TILESET_VIRIDIAN_FOREST_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
